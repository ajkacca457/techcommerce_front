...
const FeaturedCard = ({id,Name,Price,Image}) => {
  return (
    <div className='col-span-2 flex flex-col justify-between items-center group'>
      <div className="h-[250px] bg-center bg-[length:50%] w-2/3 bg-no-repeat transition duration-300 group-hover:scale-125" style={{backgroundImage:`url(${Image[0].url})`}}></div>
