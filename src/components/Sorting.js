...
const Sorting = () => {
  ...
  return (
    <div className='grid grid-cols-6 mt-8 bg-slate-400  py-2 px-4 rounded'>
        <div className='col-span-3 md:col-span-1 flex gap-x-[10px] items-center'>
        ...
        <div className='col-span-3 md:col-span-3 uppercase text-xs justify-self-end md:justify-self-center md:text-sm'>
